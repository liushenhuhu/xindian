  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="停用状态" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择停用状态" clearable>
          <el-option
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['discount_code:code:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['discount_code:code:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['discount_code:code:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['discount_code:code:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listCode, getCode, delCode, addCode, updateCode } from "@/api/discount_code/code";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getCode(promotionId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除医师优惠编号为"' + promotionIds + '"的数据项？').then(function() {
        return delCode(promotionIds);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('discount_code/code/export', {
        ...this.queryParams
