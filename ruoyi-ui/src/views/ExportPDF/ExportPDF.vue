        ...
        <div class="main">
          ...
          <div class="box2 clearfix">
            <div class="box2-left">
              ...
              <div class="box2-left-bottom">
                ...
                <div class="box2-1">
                  最慢心率:
                  <strong>{{froms.heartRate.slowestHeartRate}}</strong> bpm,发生于
                  <strong>{{froms.heartRate.slowestTime}}</strong>
                </div>
                <div class="box2-1">
                  最快心率:
                  <strong>{{froms.heartRate.fastestHeartRate}}</strong> bpm,发生于
            ...
            <div class="box2-right">
              ...
              <div class="box2-right-bottom">
                <div class="box2-1">
                  心动过缓总持续时间:
                  <strong>{{froms.heartbeat.bradycardiaTotalDuration}}</strong>
                </div>
                <div class="box2-1">
                  心动过速总持续时间:
                  <strong>{{froms.heartbeat.tachycardiaTotalDuration}}</strong>
                </div>
                <div class="box2-1">
                  最长心动过缓心搏数:
                  <strong>{{froms.heartbeat.longestBradycardia}}</strong>
                </div>
                <div class="box2-1">
                  最长心动过速心搏数:
                  <strong>{{froms.heartbeat.longestTachycardia}}</strong>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="box5">
            ...
            <div>
              ...
              <span>
                SDANN:
                <strong>{{froms.heartRateVariabilityAnalysis.SDANN}}</strong> ms
              </span>
              <span>
                SDNN Index:
                <strong>{{froms.heartRateVariabilityAnalysis.SDNNIndex}}</strong>
              </span>
              <span>
                rMSSD:
