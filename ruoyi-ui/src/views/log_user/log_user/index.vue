  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="是否疑似病理" prop="isSuspected" label-width="100">
        <el-select
          v-model="queryParams.isSuspected"
          placeholder="请选择是否疑似病理"
          clearable
        >
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否确认删除标注分配编号为"' + logIds + '"的数据项？')
        .then(function () {
    ...
    handleLook(row) {
      ...
      // createBy: null;
      // createTime: null;
      // eventDescription: "长RR间期";
      // eventName: "长RR间期";
      // isSuspected: 1;
      // logId: "8eba952e-1a24-5598-ac8d-7f6ad47a0275";
      // logNoise: 1;
      // logNoiseLevel: "AAAAAAAAAAAD";
      // logTime: null;
      // logType: "长RR间期";
      // pId: null;
      // params: Object;
