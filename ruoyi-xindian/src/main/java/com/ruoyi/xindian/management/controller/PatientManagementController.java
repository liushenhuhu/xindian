package com.ruoyi.xindian.management.controller;
...
public class PatientManagementController extends BaseController
{
     ...
     * 查询患者管理列表
     */
    @PreAuthorize("@ss.hasPermi('management:management:list')")
    @GetMapping("/list")
     ...
     * 导出患者管理列表
     */
    @PreAuthorize("@ss.hasPermi('management:management:export')")
     ...
     * 新增患者管理
     */
    @PreAuthorize("@ss.hasPermi('management:management:add')")
     ...
     * 修改患者管理
     */
    @PreAuthorize("@ss.hasPermi('management:management:edit')")
