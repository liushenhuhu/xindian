 ...
 * @TableName ecg_count
 */
@TableName(value ="ecg_count")
public class EcgCount implements Serializable {
    /**
     * 
     */
    @TableId
    ...
    public String toString() {
        return "EcgCount{" +
                ...
                ", qbxlEcg=" + qbxlEcg +
                ", sxxdgsEcg=" + sxxdgsEcg +
                ", ssxxdgsEcg=" + ssxxdgsEcg +
                ", jjxxdgsEcg=" + jjxxdgsEcg +
                ", fxxdgsEcg=" + fxxdgsEcg +
                ", fxybEcg=" + fxybEcg +
                ", fxzbEcg=" + fxzbEcg +
                ", fxtbEcg=" + fxtbEcg +
                ...
                ", ydfszdEcg=" + ydfszdEcg +
                ", edfszdEcg=" + edfszdEcg +
                ", edixfszdEcg=" + edixfszdEcg +
                ", ediixfszdEcg=" + ediixfszdEcg +
                ", sdfszdEcg=" + sdfszdEcg +
                ", dfzdEcg=" + dfzdEcg +
                ", gdfszdEcg=" + gdfszdEcg +
                ", zqfzzdEcg=" + zqfzzdEcg +
                ", zhfzzdEcg=" + zhfzzdEcg +
                ", wqxzszzdEcg=" + wqxzszzdEcg +
                ", bwqxzszzdEcg=" + bwqxzszzdEcg +
                ", wqxyszzdEcg=" + wqxyszzdEcg +
                ", bwqxyszzdEcg=" + bwqxyszzdEcg +
                ", ftyxsnzdEcg=" + ftyxsnzdEcg +
                ", sncyxcdEcg=" + sncyxcdEcg +
                ", xsyjbEcg=" + xsyjbEcg +
                ", yjzhzEcg=" + yjzhzEcg +
                ", zxffdEcg=" + zxffdEcg +
                ", zxsfdEcg=" + zxsfdEcg +
                ...
                ", tbycEcg=" + tbycEcg +
                ", qtjqycEcg=" + qtjqycEcg +
                ", qtcjqycEcg=" + qtcjqycEcg +
                ", kjubEcg=" + kjubEcg +
                ", zqfjEcg=" + zqfjEcg +
                ", qjbxjgsEcg=" + qjbxjgsEcg +
                ", qcbxjgsEcg=" + qcbxjgsEcg +
                ", qgfbxjgsEcg=" + qgfbxjgsEcg +
                ", qbxjgsEcg=" + qbxjgsEcg +
                ", xbxjgsEcg=" + xbxjgsEcg +
                ", xhbxjgsEcg=" + xhbxjgsEcg +
                ", hbxjgsEcg=" + hbxjgsEcg +
                ", xcbbxjgsEcg=" + xcbbxjgsEcg +
                ", gcbbxjgsEcg=" + gcbbxjgsEcg +
                ", cbbxjgsEcg=" + cbbxjgsEcg +
                ", xnmxxjgsEcg=" + xnmxxjgsEcg +
                ", ysxjgsEcg=" + ysxjgsEcg +
                ", fsttgxxjgsEcg=" + fsttgxxjgsEcg +
                ", xjbxjgsEcg=" + xjbxjgsEcg +
                ", jbxjgsEcg=" + jbxjgsEcg +
                ", yjxEcg=" + yjxEcg +
                ", jxEcg=" + jxEcg +
                ", cjxEcg=" + cjxEcg +
