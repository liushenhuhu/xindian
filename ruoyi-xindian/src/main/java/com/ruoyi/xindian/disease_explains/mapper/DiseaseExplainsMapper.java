package com.ruoyi.xindian.disease_explains.mapper;
...
/**
* @author w
* @description 针对表【disease_explains(心电图报告解析说明)】的数据库操作Mapper
* @createDate 2024-08-16 16:39:32
* @Entity com.ruoyi.xindian.disease_explains.domain.DiseaseExplains
*/
public interface DiseaseExplainsMapper extends BaseMapper<DiseaseExplains> {
