...
public class ReportData {
    ...
    //心动过速
    private String hrFastB;
    private String hrFastTime;
    private String hrFastStartTime;
    private String hrFastEndTime;
    private String hrFastContinueTime;
    //心动过缓
    private String hrSlowB;
    private String hrSlowTime;
    private String hrSlowStartTime;
    private String hrSlowEndTime;
    private String hrSlowContinueTime;
    //室性异位心率
    private String veCount;
    private String veB;
    private String veDf;
    private String veAverage;
    private String veDouble;
    private String vevt;
    private String veBigeminy;
    private String veTrigeminy;
    //室上性异位心率
    private String seCount;
    private String seB;
    private String seDf;
    private String seAverage;
    private String seDouble;
    private String sevt;
    private String seBigeminy;
    private String seTrigeminy;
    ...
    //////////
    //NN间期直方图
    private List<LinkedList<Integer>> nnList;
    //平均NN
    private String meanNN;
    private String maxNN;
    private String minNN;
    //////////
    //心电片段
    //////////
    //心电片段
    ...
    public static ReportData getReportData() {
        ...
        LinkedList<LinkedList<Integer>> nnL = new LinkedList<>();
        nnL.add(nnList);
        reportData.setNnList(nnL);
